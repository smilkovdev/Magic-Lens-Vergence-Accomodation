...
namespace Apt.Unity.Projection
{
    ...
    public class ProjectionPlaneCamera : MonoBehaviour
    {
        ...
        public List<Camera> CopyToOtherCameras;
        ...
        private Camera cam;
        public RenderTexture sbsTexture { get; private set; }
        ...
        private void LateUpdate()
        {
            if (ProjectionScreen != null)
            {
                ...
                cam.worldToCameraMatrix = M * T;

                cam.projectionMatrix = P;

                foreach (var c in CopyToOtherCameras)
                {
                    c.nearClipPlane = cam.nearClipPlane;
                    c.farClipPlane = cam.farClipPlane;
                    c.worldToCameraMatrix = M * T;
